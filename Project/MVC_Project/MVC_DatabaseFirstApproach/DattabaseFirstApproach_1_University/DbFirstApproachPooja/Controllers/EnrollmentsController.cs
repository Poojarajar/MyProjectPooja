...
using DbFirstApproachPooja.Models;

namespace DbFirstApproachpooja.Controllers
{
    public class EnrollmentsController : Controller
    {
        private readonly UniversityPoojaContext _context;

        public EnrollmentsController(UniversityPoojaContext context)
        {
            _context = context;
        }
        ...
        {
            var universityPoojaContext = _context.Enrollments.Include(e => e.Course).Include(e => e.Student);
            return View(await universityPoojaContext.ToListAsync());
        }
