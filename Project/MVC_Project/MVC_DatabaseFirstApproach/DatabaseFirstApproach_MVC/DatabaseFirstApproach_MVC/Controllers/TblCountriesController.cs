...
using DatabaseFirstApproach_MVC.Models;

namespace DatabaseFirstApproach_MVC.Controllers
{
    public class TblCountriesController : Controller
    {
        private readonly CountryPoojadbContext _context;

        public TblCountriesController(CountryPoojadbContext context)
        {
            _context = context;
        }
