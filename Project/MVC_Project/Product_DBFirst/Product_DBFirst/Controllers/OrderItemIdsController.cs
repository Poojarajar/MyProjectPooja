...
using Product_DBFirst.Models;

namespace Product_DBFirst.Controllers
{
    public class OrderItemIdsController : Controller
    {
        ...
        {
            var productDbContext = _context.OrderItemIds.Include(o => o.Order).Include(o => o.Product);
        ...
        public IActionResult Create()
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.ProductTbls, "ProductId", "ProductId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("OrderItemId1,OrderId,ProductId,NoOfItems")] OrderItemId orderItemId)
        {
            ...
            ViewData["ProductId"] = new SelectList(_context.ProductTbls, "ProductId", "ProductId", orderItemId.ProductId);
            return View(orderItemId);
        }
